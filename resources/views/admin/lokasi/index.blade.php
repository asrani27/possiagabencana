...
@section('content')
<a href="/admin/lokasi/add" class="btn btn-sm btn-danger"><i class="fas fa-plus"></i>&nbsp; Tambah Lokasi</a> <br /><br />
<div class="row">
  <div class="col-lg-12">
    <div class="card card-primary card-outline">
      <div class="card-header">
        <h5 class="card-title m-0"> <i class="fas fa-server"></i> Data Lokasi </h5>
      </div>
        <div class="card-body">
