...
<title>Data Rekapitulasi Pengungsian</title>
<style type="text/css">
.auto-style1 {
	text-align: center;
	border-style: solid;
...
<div class="auto-style4">
	<strong><span class="auto-style5">Data Rekapitulasi Pos Pengungsian</span><br class="auto-style5" />
...
<table cellpadding="2" cellspacing="0" class="auto-style2" style="width: 100%">
	<tr style="font-size:11px">
		...
		<td class="auto-style1"><strong>Keterangan</strong></td>
	...
	<tr style="font-size:11px">
		...
		<td class="auto-style3">{{$item->keterangan}}</td>
