...
<div clsas="row">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form role="form" method="POST" action="/admin/berita/edit/{{$data->id}}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group">
                    <label>Isi</label>
                    <textarea id="summernote" name="isi" class="form-control">{{$data->isi}}</textarea>
